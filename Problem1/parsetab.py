...
_lr_productions = [
  ...
  ('exp -> atom','exp',1,'p_exp_atom','yacc.py',161),
  ('exp -> quoted_list','exp',1,'p_exp_qlist','yacc.py',166),
  ('exp -> call','exp',1,'p_exp_call','yacc.py',171),
  ('quoted_list -> QUOTE list','quoted_list',2,'p_quoted_list','yacc.py',176),
  ('list -> LPAREN items RPAREN','list',3,'p_list','yacc.py',181),
  ('items -> item items','items',2,'p_items','yacc.py',186),
  ('items -> empty','items',1,'p_items_empty','yacc.py',191),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',196),
  ('item -> atom','item',1,'p_item_atom','yacc.py',201),
  ('item -> quoted_list','item',1,'p_item_list','yacc.py',211),
  ('item -> call','item',1,'p_item_call','yacc.py',216),
  ('item -> empty','item',1,'p_item_empty','yacc.py',221),
